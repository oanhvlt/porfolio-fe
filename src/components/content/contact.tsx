        ...
        <div className="arlo_tm_section" id="contact">
            ...
            <div className="arlo_tm_footer_contact_wrapper_all">
                    ...
                    <div className="container">
                        <div className="leftbox">
                            ...
                            <div className="short_info_wrap">
                                <ul>
                                    <li><p><label>Email:</label><span><a style={{ color: '#509966' }} href="mailto:vulethuyoanh@gmail.com">vulethuyoanh@gmail.com</a></span></p></li>
                                    <li><p><label>Phone:</label><span style={{ color: '#509966' }}>+84 393 922 580</span></p></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div className="arlo_tm_footer_wrap">
                    <div className="container">
                        <p>&copy; Copyright 2019 by Oanh Vu. All Rights are Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
